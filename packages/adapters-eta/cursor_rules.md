# Cursor Rules: @mcp-prompts/adapters-eta
...
- Run tests with `pnpm test` or `pnpm -F @mcp-prompts/adapters-eta test`
...
## Import Conventions
- Use package root imports for internal modules (e.g., `@mcp-prompts/adapters-eta`)
- No relative imports across package boundaries

## Adapter-Specific Rules
- Integrates with ETA templating engine
