# Cursor Rules: @mcp-prompts/adapters-memory
...
- Run tests with `pnpm test` or `pnpm -F @mcp-prompts/adapters-memory test`
...
## Import Conventions
- Use package root imports for internal modules (e.g., `@mcp-prompts/adapters-memory/MemoryAdapter`)
- No relative imports across package boundaries

## Adapter-Specific Rules
- In-memory storage only; no file or network I/O
