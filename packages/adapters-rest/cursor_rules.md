# Cursor Rules: @mcp-prompts/adapters-rest
...
- Run tests with `pnpm test` or `pnpm -F @mcp-prompts/adapters-rest test`
...
## Import Conventions
- Use package root imports for internal modules (e.g., `@mcp-prompts/adapters-rest/RestServer`)
- No relative imports across package boundaries

## Adapter-Specific Rules
- Direct HTTP/REST access is allowed (express, fetch, etc.)
- All endpoints must validate input/output with Zod schemas
- No business logic: only transport concerns
