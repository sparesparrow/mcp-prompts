 ...
 * 
 * This module consolidates all prompt-related management functionality:
...
function generateDescription(content: string): string {
  // Remove template variables for description generation
  const cleanContent = content.replace(/\{\{[^}]+\}\}/g, '___');
