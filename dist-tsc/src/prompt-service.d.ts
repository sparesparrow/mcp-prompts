import type { CreatePromptParams, ListPromptsOptions, Prompt, StorageAdapter, UpdatePromptParams } from './interfaces.js';
...
export declare class PromptService {
     ...
     */
    createPrompt(args: CreatePromptParams): Promise<Prompt>;
    private generateId;
    /**
     ...
     */
    applyTemplate(id: string, variables: Record<string, any>, version?: number): Promise<ApplyTemplateResult>;
    /**
