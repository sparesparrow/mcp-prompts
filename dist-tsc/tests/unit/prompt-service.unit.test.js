...
describe('PromptService', () => {
    ...
    it('should create and retrieve a prompt', async () => {
        ...
        expect(mockAdapter.savePrompt).toHaveBeenCalledWith(expect.objectContaining({ name: 'Unit Test Prompt' }));
    ...
    it('should update a prompt', async () => {
        ...
        expect(mockAdapter.updatePrompt).toHaveBeenCalledWith('update-test', 1, expect.objectContaining(updatedData));
    ...
    describe('Conditional Templating', () => {
        ...
        it('should handle truthy and falsy values', async () => {
            const prompt = {
                ...
                content: '{{#if item}}Item exists.{{/if}}{{#if nonItem}}No item.{{/if}}{{#if count}}Has count.{{/if}}',
                isTemplate: true,
                version: 1,
                createdAt: new Date().toISOString(),
                updatedAt: new Date().toISOString(),
